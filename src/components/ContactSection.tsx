      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <button
              type="submit"
            className="bg-primary text-primary-foreground px-8 py-4 font-sans-modern text-sm tracking-widest uppercase hover:bg-primary/90 hover:scale-105 transition-all duration-300"
            >
              Enviar mensagem
            </button>
          </form>
