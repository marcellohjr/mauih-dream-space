      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mt-16">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 bg-secondary text-secondary-foreground px-8 py-4 font-sans-modern text-sm tracking-widest uppercase hover:bg-secondary/90 hover:scale-105 transition-all duration-300"
          >
